                        ...
                        <div id="joinForm">
                            <form v-on:submit.prevent="join" action="" method="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input >
                                </div>type="text" id="input-pass" name="password" v-model="userVo.password"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" id="chk-agree" name="" v-model="agree">
    ...
    methods: {
        join(event) {
            ...
            if (this.userVo.id == "") {
                ...
                return false;//이벤트 전파를 막는다
            } else if (this.userVo.gender == "") {
                event.preventDefault();//폼기능 제한
                window.alert("성별을 체크해주세요");//경고장
                return false;//이벤트 전파를 막는다
            } else if (this.agree == "") {
                event.preventDefault();//폼기능 제한
                window.alert("약관에 동의해주세요");//경고장
                return false;//이벤트 전파를 막는다
            }else {
                axios({
