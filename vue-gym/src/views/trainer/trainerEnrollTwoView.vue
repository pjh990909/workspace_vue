    ...
    <div id="trEnrollAll">
        ...
        <div>
            <form v-on:submit.prevent="uploadFile" action="" method="">
                <div>
                    <img id="EnrollImgTray" v-bind:src="`http://localhost:9000/upload/${trainerVo.saveName}`" alt="">
